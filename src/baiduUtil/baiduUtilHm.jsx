export default function (web) {
  ...
  let h = {}
      , mt = {}
      , c = {
        // id: "631ccab496c31a33264f6c3f43262f3b",
        id: domainId,
        dm: ["baidu.com"],
  ...
  console.log(`https://hm.baidu.com/hm.js?${  c.id}`);
  let r = void 0
      , s = !0
      , t = null
      , w = !1;
  ...
  mt.localStorage.set = function(a, b, f) {
    ...
    try {
      window.localStorage ? (b = `${d.getTime()  }|${  b}`,
            window.localStorage.setItem(a, b)) : mt.localStorage.A() && (mt.localStorage.g.expires = d.toUTCString(),
  ...
  (function() {
    let a = {
      ...
      r: function(a, f) {
        this.l[a] = this.l[a] || [];
        for (let d = this.l[a].length, g = 0; g < d; g++)
          this.l[a][g](f)
      }
    };
    return h.D = a
  ...
  (function() {
    function a(a, d) {
      ...
      g.src = a;
      let l = document.getElementsByTagName("script")[0];
  ...
  (function() {
    ...
    function f(a) {
      ...
      if (a in p)
        m = a;
                ...
                for (let b = ["webkit", "ms", "moz", "o"], k = 0; k < b.length; k++) {
                  let q = b[k] + a.charAt(0).toUpperCase() + a.slice(1);
                  if (q in p) {
                    m = q;
                    break
                  }
    ...
    function d(a) {
      if (!("focus" == a.type || "blur" == a.type) || !(a.target && a.target != window))
        k = "focus" == a.type || "focusin" == a.type ? s : w,
                b()
    }
    var g = mt.event, l = h.D, n = s, e = s, m = s, k = s, v = +new Date, p = v, q = 0, u = s, x = f("visibilityState"), z = f("hidden"), y;
    b();
    (function() {
      let a = x.replace(/[vV]isibilityState/, "visibilitychange");
      g.c(document, a, b);
          ...
          , e = {
            ...
            da: function() {
              ...
              if (!a || f.d(a, "Array"))
                window._hmt = {
                  ...
                  cmd: {},
                  push: function() {
                    for (let a = window._hmt, m = 0; m < arguments.length; m++) {
                      let p = arguments[m];
            ...
            fa: function() {
              ...
              if (a && a.cmd && a.cmd[c.id])
                for (let b = a.cmd[c.id], d = /^_track(Event|MobConv|Order|RTEvent)$/, p = 0, q = b.length; p < q; p++) {
                  let f = b[p];
            ...
            ga: function() {
              if (0 < e.p.length)
                for (let a = 0, b = e.p.length; a < b; a++)
                  e.L(e.p[a]);
              e.p = t
            },
            L: function(a) {
              ...
              if (f.d(b, "Object")) {
                ...
                if (900 >= l)
                  k.call(this, b);
                        ...
                        for (var l = Math.ceil(l / 900), p = `block|${  Math.round(Math.random() * g.K).toString(16)  }|${  l  }|`, q = [], u = 0; u < l; u++)
                          q.push(u),
  ...
  (function() {
    ...
    a.prototype = {
      ...
      P: function() {
        for (let a = 0, b = c.dm.length; a < b; a++) {
          let d = c.dm[a];
          if (-1 < d.indexOf("/") && this.T(document.location.href, d))
            return `${d.replace(/^[^\/]+(\/.*)/, "$1")  }/`
        }
        return "/"
      },
      na: function() {
        if (!document.referrer)
          return k.k - k.m > c.vdur ? 1 : 4;
        let a = w;
        this.s(document.referrer) && this.s(document.location.href) ? a = s : (a = b.Q(document.referrer),
      ...
      Da: function() {
        let a, b, d, f, e;
        k.m = this.getData(`Hm_lpvt_${  c.id}`) || 0;
        ...
        if (0 === c.nv && this.s(document.location.href) && ("" === document.referrer || this.s(document.referrer)))
          a = 0,
                    b = 4;
        this.a.nv = a;
        this.a.st = b;
      ...
      Ea: function() {
        ...
        this.a.ci = b.f(a, k.pa) || b.f(a, k.Ha) || "";
      ...
      h: function(a) {
        let b = this;
        b.a.rnd = Math.round(Math.random() * k.K);
        v.r("stag-b");
        let d = `${k.J  }//${  k.U  }?${  b.Ca()}`;
        v.r("stag-d");
        b.Z(d);
      ...
      ba: function() {
        let a = document.location.hash.substring(1)
                  , d = RegExp(c.id)
                  , f = -1 < document.referrer.indexOf(k.$)
                  , e = b.f(a, "jn")
                  , g = /^heatlink$|^select$/.test(e);
        a && (d.test(a) && f && g) && (this.a.rnd = Math.round(Math.random() * k.K),
                a = document.createElement("script"),
                a.setAttribute("type", "text/javascript"),
                a.setAttribute("charset", "utf-8"),
                a.setAttribute("src", `${k.protocol  }//${  c.js  }${e  }.js?${  this.a.rnd}`),
      ...
      M: function(a) {
        let b = m.get(`Hm_unsent_${  c.id}`) || "";
        b && (a = encodeURIComponent(a.replace(/^https?:\/\//, "")),
                a = RegExp(`${a.replace(/([\*\(\)])/g, "\\$1")  }(%26u%3D[^,]*)?,?`, "g"),
                (b = b.replace(a, "").replace(/,$/, "")) ? m.set(`Hm_unsent_${  c.id}`, b) : m.remove(`Hm_unsent_${  c.id}`))
      },
      Ba: function() {
        var a = this
    ...
    try {
      if (window.performance && performance.timing && "undefined" !== typeof h.b) {
        ...
        let e = function() {
          ...
          a = document.referrer;
          let m = a.match(/^(http[s]?:\/\/)?([^\/]+)(.*)/) || []
                      , u = t;
          b = t;
          if ("www.baidu.com" === m[2] || "m.baidu.com" === m[2])
            u = f.f(a, "qid"),
                        b = f.f(a, "click_t");
          a = u;
          e.qid = a != t ? a : "";
          b != t ? (e.bdDom = n ? n - b : 0,
                    e.bdRun = g - b,
                    e.bdDef = l("navigation").start - b) : (e.bdDom = 0,
                    e.bdRun = 0,
                    e.bdDef = 0);
          h.b.a.et = 87;
    ...
    if ("undefined" !== typeof h.b && (c.med || (!a.xa || 7 < a.va) && c.cvcc)) {
      ...
      if (c.med)
        l = "/zoosnet",
                ...
                e = {
                  click: function() {
                    for (var a = [], b = m(document.getElementsByTagName("a")), b = [].concat.apply(b, m(document.getElementsByTagName("area"))), b = [].concat.apply(b, m(document.getElementsByTagName("img"))), d, f, e = 0, g = b.length; e < g; e++)
                      d = b[e],
        ...
        e = {
          click: function() {
            for (var a = [], b = m(document.getElementsByTagName("a")), b = [].concat.apply(b, m(document.getElementsByTagName("area"))), b = [].concat.apply(b, m(document.getElementsByTagName("img"))), d, e, f, g = 0, l = b.length; g < l; g++)
              d = b[g],
                            n !== r ? (e = d.getAttribute("onclick"),
                            f = d.getAttribute("href"),
                            p ? (d = d.getAttribute("id"),
                            (n.test(e) || n.test(f) || p.test(d)) && a.push(b[g])) : (n.test(e) || n.test(f)) && a.push(b[g])) : p !== r && (d = d.getAttribute("id"),
                            p.test(d) && a.push(b[g]));
            return a
          }
        }
      ...
      var g = {
        Y: function() {
          for (var b = c.cvcf.length, d, e = 0; e < b; e++)
            (d = a.ia(decodeURIComponent(c.cvcf[e]))) && f.c(d, "click", g.ea())
        },
        ea: function() {
          return function() {
            h.b.a.et = 86;
